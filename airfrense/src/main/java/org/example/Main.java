...
public class Main {
    ...
    private static ReservationProvider sophie;
    private static ReservationService nicolas;
    private static VehiculeCategoryProvider maxime;
    private static VehiculeSubCategoryProvider theo;
    private static VehiculeService anna;

    private static void bootstrapContainer() {
        sophie = new ReservationProvider();
        nicolas = new ReservationService(sophie);
        maxime = new VehiculeCategoryProvider();
        theo = new VehiculeSubCategoryProvider();
        anna = new VehiculeService(maxime, theo);
